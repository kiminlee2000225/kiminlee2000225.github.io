    ...
    return (
          <div className="projectContext">
           <div className="projectInfoWrapper">
            ...
            <h2><a href="https://lucyslovebus.org" style={{textDecoration: 'none', color: "#222626"}}>Lucy's Love Bus</a></h2>
            <h2><a href="http://lovebusprograms.org/ " style={{textDecoration: 'none', color: "#222626"}}>Created Software</a></h2>
            <h2>Tools used</h2>
